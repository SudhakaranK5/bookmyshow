...
Instalation:
1.JAVA
To install [java](https://www.oracle.com/java/technologies/downloads/) visit the official JAVA website in ORACLE.
2.MYSQL
To install [MYSQL](https://dev.mysql.com/downloads/installer/) visit the official MYSQL website in ORACLE.
